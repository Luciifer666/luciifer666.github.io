...
function displayTrendCoins(coins) {
    ...
    coins.forEach(coin => {
        ...
        `;
        row.onclick = () => window.location.href = `/pages/special/Crypto_Marketplace/pages/coin.html?coin=${coinData.id}`;
...
function displayAssets(data) {
    ...
    data.forEach(asset => {
        ...
        row.onclick = () => window.location.href = `/pages/special/Crypto_Marketplace/pages/coin.html?coin=${asset.id}`;
    });
